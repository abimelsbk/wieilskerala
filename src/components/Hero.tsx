    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          >
            IEEE <span className="text-purple-300">WiE</span> International Leadership Summit
          </h1>
          ...
          >
            ...
            <span className="block mt-2 text-sm md:text-base italic">— Diane Mariechild</span>
          </p>
