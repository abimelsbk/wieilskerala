        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-full">
            ...
            <p className="text-white/80 text-lg mb-6 leading-relaxed">
              Do you have a big idea that could change the world? Our
              Entrepreneurs' Challenge gives early-stage, women-led startups the
            ...
            <div className="flex flex-col sm:flex-row gap-8 mb-10">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Present your startup to industry experts and investors
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Connect with experienced entrepreneurs and mentors
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Become a role model for aspiring women entrepreneurs
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 p-5 rounded-xl">
                    ...
                    <p className="text-white/80 italic">
                      "The mentorship and connections I gained through the WIE
                      challenge propelled my startup to secure our first major
                      funding round."
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 p-5 rounded-xl">
                    ...
                    <p className="text-white/80 italic">
                      "Participating in the challenge gave me the confidence and
                      visibility needed to transform my research into a thriving
                      health tech company."
                    </p>
                  </div>
                </div>
