  ...
  const highlights = [
    {
      ...
      description:
        "Engage with thought leaders from tech, policy, entrepreneurship & arts from around the world.",
    },
    {
      icon: Sunrise,
      title: "Morning Yoga",
      description:
        "Begin each day with peaceful yoga sessions by the serene Chaliyar River.",
    },
    {
      icon: Music,
      title: "Cultural Performances",
      description:
        "Experience breathtaking cultural performances under the stars.",
    },
    {
      icon: Lightbulb,
      title: "Creative Workshops",
      description:
        "Participate in hands-on, tech-driven workshops to boost your skills.",
    },
    {
      icon: Users,
      title: "Entrepreneurs' Challenge",
      description:
        "A special challenge designed for women entrepreneurs to showcase their innovative ideas.",
    },
    {
      icon: School,
      title: "STEM Outreach",
      description:
        "Connect with school students through our dedicated STEM outreach program.",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            Whether you're a student, professional, artist, or changemaker — WIE
            ILS is designed to spark new ideas, collaborations, and inner
            clarity.
          </p>
        </div>
